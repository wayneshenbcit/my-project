...
//***********************************************************************************
let outputA = document.getElementById('ShowBicycle');
//***********************************************************************************
//STAGE - 2 , Pacman Animation
//***********************************************************************************
let outputB = document.getElementById('ShowPacman');
//***********************************************************************************
//STAGE - 1 , Bicycle Animation
//***********************************************************************************
let html = "";
let htmlResult = "";
let pathToImages = "./product/";
let path = "";
...
const startButtons = outputA.querySelectorAll('button[name="start-animation-demo-01"]');
const reverseButtons = outputA.querySelectorAll('button[name="reverse-animation-demo-01"]');
const stopButtons = outputA.querySelectorAll('button[name="stop-animation-demo-01"]');
let timeoutHandler; //no value 
let timeOut = 1000 * 60; //1*10 second
let intervalHandler; //no value 
...
const upButtons = outputB.querySelectorAll('button[name="btn-up"]');
const leftButtons = outputB.querySelectorAll('button[name="btn-left"]');
const rightButtons = outputB.querySelectorAll('button[name="btn-right"]');
const downButtons = outputB.querySelectorAll('button[name="btn-down"]');
const pauseButtons = outputB.querySelectorAll('button[name="btn-pause"]');
const pacManImageInHTML = document.getElementById('pac-man');
...
function AnimatePacMan() {
    ...
    if (moveRight === true) {
        ...
        horizontalPosition++;
        if (pacManImageInHTML)
            pacManImageInHTML.style.transform = 'scaleX(1)';
    ...
    if (moveDown == true) {
        ...
        */
        if (pacManImageInHTML)
            pacManImageInHTML.style.transform = 'rotate(90deg)';
        /* ---------------------------------------------------------------------------------------------------*/
...
/* ----------------------------------------------------------------------------------------------------*/
function getBikeImages(index) {
    let path1 = "bike-";
    let path2 = index.toString();
    let path3 = ".jpg";
